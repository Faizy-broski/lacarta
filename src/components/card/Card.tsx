const Card = ({ image, category, title, author, time, className = "" }) => (
  ...
  >
    ...
    <div className="absolute bottom-0 left-0 right-0 p-5">
      <span className="inline-block bg-white text-black text-[10px] font-bold px-2 py-1 mb-2">
        {category}
      </span>
      ...
      <div className="bg-red-600 text-white text-xs flex items-center px-3 py-2">
        <span>{author}</span>
